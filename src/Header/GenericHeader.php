...
class GenericHeader implements HeaderInterface, UnstructuredInterface
{
    ...
    public static function splitHeaderLine($headerLine)
    {
        if (mb_detect_encoding($headerLine, ['ASCII', 'UTF-8'], true) === 'UTF-8') {
            ...
            $replace = ['A','A','A','A','AE','A','AE','C','E','E','E','E','I','I','I','I','ETH','N','O','O','O','O','OE','x','O','U','U','U','UE','Y','THORN','ss','a','a','a','a','ae','a','ae','c','e','e','e','e','i','i','i','i','o','n','o','o','o','o','oe','/','o','u','u','u','ue','y','thorn','y','A','a','A','a','C','c','C','c','D','d','D','d','E','e','E','e','L','l','L','l','L','l','N','n','N','n','OE','oe','OE','oe','R','r','R','r','S','s','S','s','S','s','T','t','T','t','U','u','UE','ue','Y','Z','z','Z','z','Z','z','f'];
